...
@endif
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12"><b>Impostazioni</b><p>Mantieni proporzioni immagini (l'immagine si estende fino alla larghezza dello schermo e successivamente calcola proporzionalmente l'altezza): <input type="checkbox" name="proportions1" value="1" checked /></p><p>Lettura dal basso: <input type="checkbox" name="read_down1" value="1" /></p><p>
                                Scroll assistito: <input type="checkbox" name="fast_scroll1" value="1" /></p>
                                <p>
                                Scroll automatico (SE IMPOSTATO DESELEZIONARE LO SCROLL ASSISTITO) - esprimere tempo in ms: <input type="input" name="auto_scroll1" value="0" /></p></div>
